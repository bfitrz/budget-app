  ...
  return (
    <Box>
      ...
      <Section title="Synchronizacja z Google Drive" icon={<DataIcon sx={{ fontSize: 18 }} />}>
        ...
        <Feature label="Banner zmian po reload" description="Po odświeżeniu strony apka od razu sprawdza czy plik na Drive jest nowszy niż Twoja ostatnia synchronizacja. Jeśli kolega coś zmienił — banner '🔄 Nowa wersja od X' pojawia się natychmiast w prawym górnym rogu." />
        <Feature label="Kto ostatnio edytował" description="Na stronie 'Dane i sync' widać: datę ostatniej synchronizacji, datę edycji pliku na Drive, oraz imię osoby która ostatnio zapisała. W bannerze zmian też wyświetla się imię." />
        <Feature label="Powiadomienie o nowej wersji" description="Gdy wyjdzie nowa wersja aplikacji, w prawym górnym rogu pojawi się blok 'Nowa wersja X.Y.Z' z przyciskiem 'Odśwież'. Sprawdzane co 60 sekund." />
